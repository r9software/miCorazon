				...
				<div class="registro-box">
					...
					<div class="g-registro">
						...
						<div class="form-group2">
							<label>Correo electrónico:</label><input type="text" name="mail" value="<?php
							if ( isset( $_GET['mail'] ) ) {
								echo $_GET['mail'];
							}
							?>" class="field2" />
																	 <?php if ( isset( $_GET['mailm'] ) ) { ?>					
						...
						<div class="form-group2 single-space">
							<label>Crear contraseña:</label><input type="password" name="pass1" value="" class="field2" />

						</div>
						<div class="form-group2">
							<label>Confirmar contraseña:</label><input type="password" name="pass2" value="" class="field2" />
							<?php if ( isset( $_GET['passV'] ) ) { ?>	
								<div class="alert3" id="alert-password">
									*La contrase&ntilde;a esta vacia.
								</div>
							<?php } ?>
							<?php if ( isset( $_GET['passC'] ) ) { ?>	
								<div class="alert3" id="alert-password">
						...
						<div class="form-group single-space">
							<label>Nombre:</label><input type="text" name="n" value="<?php
							if ( isset( $_GET['n'] ) ) {
								echo $_GET['n'];
							}
							?>" class="field2" />
						...
						<div class="form-group2 single-space">
							<label>Apellido paterno:</label><input type="text" name="ap" value="<?php
							if ( isset( $_GET['ap'] ) ) {
								echo $_GET['ap'];
							}
							?>" class="field2" />
						...
						<div class="form-group2">
							<label>Apellido materno:</label><input type="text" name="am" value="<?php
							if ( isset( $_GET['am'] ) ) {
								echo $_GET['am'];
							}
							?>" class="field2" />
																   <?php if ( isset( $_GET['amm'] ) ) { ?>	
						...
						<div class="form-group">
							...
							<div class="cuatro customui" style="margin-top:5px;">
								...
								?>/><label for="generof" class="radie"  style="width:120px; ">Femenino</label>
									   <?php if ( isset( $_GET['gm'] ) ) { ?>	
									<div class="alert3" id="alert-genero" style="left:7%;">
										*Campo obligatorio
									</div>
								<?php } ?>
							</div>
