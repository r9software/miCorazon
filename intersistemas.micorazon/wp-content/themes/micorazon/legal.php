						...
						<ol>
							...
							<ol>
								...
								<div class="content-all">
									...
									<div class="header">
										<div class="wrap">
											<div class="logo3"><a href="home-page"></a></div>
											<div class="logo4"></div>
										</div>
									</div>
...
<?php } ?>
													...
													<div class="file">
															<form name="myform" id="myform" enctype="multipart/form-data" method="POST" action="<?php echo site_url() . '/imagen-dao/'; ?>" >
																...
																<button class="btn-file-input" onclick="subirFoto()">Actualizar foto</button>
															</form>  
														</div>
													<!--
	 												 <button class="btn-file-input">Elegir foto</button>
												...
												<div class="risk-box">
													...
													?>"><?php echo $myvar ?>
														...
														?>
															...
															<div class="visitanos"><p>Encuentra más información, consejos y recetas para llevar una vida saludable en nuestro sitio <span><a href="home-page">www.micorazonsaludable.com</a></span></p></div>
