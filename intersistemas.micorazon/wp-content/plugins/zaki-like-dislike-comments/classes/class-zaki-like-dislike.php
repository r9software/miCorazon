...
final class ZakiLikeDislike {
    ...
    public static function getLikeBtn($post_id = NULL , $classes = array()) {
        ...
        ?>
        <div class="<?=$new_classes?> ump" data-postid="<?=$post_id?>" data-ratetype="like">
            <img src="<?=plugins_url( 'images/cora_on.png' , ZAKI_LIKE_DISLIKE_FILE )?>" />
    ...
    public static function getDislikeBtn($post_id = NULL , $classes = array()) {
        ...
        ?>
        <div class="<?=$new_classes?> ump" data-postid="<?=$post_id?>" data-ratetype="dislike" >
            <img src="<?=plugins_url( 'images/cora_off.png' , ZAKI_LIKE_DISLIKE_FILE )?>" />
