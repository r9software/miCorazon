				...
				<div class="perfil-box">
					<div class="user">
						...
						<div class="user-info">
							...
							<a  onclick="subirFoto()" class="cambio">Cambiar foto</a>
						</div>
					</div>
					...
					<div class="risk-row">
						<div class="risk-box" id="fact1">
							...
							if ( !$presion ) {
								...
								echo "<h3>Nivel sano: Menos de 120 - 80</h3>";
								...
								if ( $cps < 120 && $cpd < 80 )
									...
									$mylevel = "alto";
								echo "<h2>Presión arterial</h2>";
								echo "<h3>Nivel actual: <span class='" . $mylevel . "'>" . $cps . " - " . $cpd . "</span></h3>";
								echo "<h3>Nivel sano: Menos de 120 - 80</h3>";
						...
						<div class="risk-box" id="fact2">
							...
							if ( !$glucosa ) {
								...
								echo "<h3>Nivel sano: Menos de  70 a 100 mg/dL</h3>";
					...
					<div class="risk-row">
						<div class="risk-box" id="fact5">
							...
							if ( $imc <= 24.9 )
								...
								$mylevel = "alto";
							echo "<h2>Peso (IMC)</h2>";
							echo "<h3>Nivel actual: <span class='" . $mylevel . "'>" . $imc . "</span></h3>";
							echo "<h3>Nivel sano: 19 a 24.9</h3>";
						...
						<div class="risk-box" id="fact6">
							...
							echo "<h3>Raciones recomendadas:  5 o más</h3>";
					...
					<div class="risk-row">
						...
						<div class="risk-box" id="fact8">
							...
							echo "<h3>Nivel: <span class='" . $mylevel . "'>" . $afisicas . "</span></h3>";
							echo "<h3>Nivel sano:  5</h3>";
						...
						<div class="risk-box" id="fact10">
							...
							echo "<h3>Nivel: <span class='" . $mylevel . "'>" . $ftot . "</span></h3>";
							echo "<h3>Nivel sano:  0</h3>";
						...
						<div class="risk-box" id="fact9">
							...
							echo "<h2>Sueño</h2>";
							echo "<h3>Nivel: <span class='" . $mylevel . "'>" . $hsueno . "</span></h3>";
							echo "<h3>Nivel sano:  2</h3>";
