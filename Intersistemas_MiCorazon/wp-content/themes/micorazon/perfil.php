                ...
                <div class="page">
                    ...
                    <div class="perfil-box">
                        <div class="user">
                            ...
                            <div class="user-info">
                                <h4>Juan José Gutiérrez Prado</h4>
                                <a href="#" class="cambio">Cambiar foto</a>
                            </div>
                        </div>
                        <div class="riesgos-box riesgo-bajo">
                            <h1>Mi corazón está en:</h1>
                            <h2>Riesgo bajo</h2>
                            <p>¡Muchas felicidades! Los resultados de tus mediciones señalan que tu salud cardiosaludble es óptima.</p>
                            <p>Tenemos buenas noticias para ti: “vas por muy buen camino”. Tus cifras de glucosa y colesterol se encuentran dentro de límites aceptables no dejes que se eleven. Mantén tu peso como hasta ahora y evita que los kilos de más te alcancen. Sigue consumiendo al menos dos frutas y tres verduras al día, no olvides el pescado al menos una vez a la semana, pero de preferencia dos veces. Continúa con ese nivel de actividad física o auméntalo un poco si te es posible. Tu salud agradece que no fumes.</p>
...
Realiza tu árbol genealógico de enfermedades y verás cómo puedes evitar o retrasar la aparición de problemas cardiacos.</strong></p>
                        ...
                        <div class="risk-row">
                            <div class="risk-box" id="fact1">
                                ...
                                <h3>Nivel actual: <span class="bajo">90 - 70</span></h3>
                                <h3>Nivel sano: Menos de 120 - 80</h3>
                                <a id="light-fact1-bajo">Detalle</a>
                            </div>
                            <div class="risk-box" id="fact2">
                                <h2>Glucosa en la sangre</h2>
                                <h3>Nivel actual: <span class="medio">101 a 125 mg/dL</span></h3>
                                <h3>Nivel sano: 70 a 100 mg/dL</h3>
                                <a id="light-fact2-medio">Detalle</a>
                            </div>
                            <div class="risk-box" id="fact3">
                                <h2>Triglicéridos</h2>
                                <h3>Nivel actual: <span class="alto">328 mg/dL</span></h3>
                                <h3>Nivel sano: 200 a 499 mg/dL</h3>
                                <a id="light-fact3-alto">Detalle</a>
                            </div>
                        </div>
                        <div class="risk-row">
                        ...
                        <div class="risk-row">
                            <div class="risk-box" id="fact7">
                                <h2>Estrés</h2>
                                <h3>Nivel: <span class="alto">3</span></h3>
                                <h3>Nivel sano: 1</h3>
                                <a id="light-fact7-alto">Detalle</a>
                            </div>
                            <div class="risk-box" id="fact8">
                                <h2>Actividad física</h2>
                                <h3>Nivel: <span class="alto">3</span></h3>
                                <h3>Nivel sano: 1</h3>
                                <a id="light-fact8-alto">Detalle</a>
                            </div>
                            <div class="risk-box" id="fact9">
                                <h2>Sueño</h2>
                                 <h3>Nivel: <span class="alto">3</span></h3>
                                <h3>Nivel sano: 1</h3>
                                <a id="light-fact9-alto">Detalle</a>
                            </div>
                        </div>
                         <div class="risk-row last">
                             <div class="risk-box" id="fact10">
                                ...
                                <h3>Nivel: <span class="alto">3</span></h3>
                                 <h3>Nivel sano: 1</h3>
                                <a id="light-fact10-alto">Detalle</a>
                            </div>
                             <div class="risk-box">
                                <h2>Padecimientos<br/> heredofamiliares</h2>
                                <h3><span class="alto">Presentes</span></h3>
                            </div>
                             <div class="risk-box">
                        ...
                        <div class="motivaciones-row">
                            ...
                            <label>Verme mejor<a href="#">Editar</a></label>
                            <label>Verme mejor<a href="#">Editar</a></label>
                            <label>Verme mejor<a href="#">Editar</a></label>
                        </div>
                        <div class="cont-submit5">
                            <a href="home-page/" class="submit2">!Comienza una vida más sana!</a>
                        </div>
